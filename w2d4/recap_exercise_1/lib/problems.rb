    ...
    words.each_with_index do |word_1, idx1| 
        words.each_with_index do |word_2, idx2|
            if idx2 > idx1
                ...
                if vowels.split("").all? { |ele| new_string.include?(ele) }
                    result << new_string
                end
            end
        end
...
class String
    ...
    def substrings(length = nil)
        ...
        self.each_char.with_index do |char_1, idx1|
            result << char_1
            str = char_1
            self.each_char.with_index do |char_2, idx2|
                if idx2 > idx1  
                    str += char_2
                    result << str  # self[idx1..idx2]
                end
            end
        end
